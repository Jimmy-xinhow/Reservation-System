...
const checks = [
  ...
  ["patient list exposes membership setup and edits details in a tenant-scoped modal", ["app/admin/patients/page.tsx|<AdminModal", "app/admin/patients/page.tsx|會員等級設定", "app/admin/patients/page.tsx|updatePatientDetailsAction", "app/admin/patient-actions.ts|會員等級不屬於目前品牌或已停用", "app/admin/patient-actions.ts|.eq(\"clinic_id\", member.clinicId)"]],
