...
const checks = [
  ...
  ["operations dashboard, finance drill-down, and generic service records are connected", ["app/admin/actions.ts|redirect(\"/admin/dashboard\")", "components/AdminNav.tsx|營運中心", "components/AdminNav.tsx|服務營運總覽", "components/AdminNav.tsx|服務過程紀錄", "app/admin/dashboard/page.tsx|本月營運與庫存", "app/admin/dashboard/page.tsx|客服對話", "app/admin/dashboard/page.tsx|上班打卡", "app/admin/beauty/page.tsx|跨產業營運", "app/admin/operations/finance/page.tsx|財務摘要", "app/admin/operations/service-records/page.tsx|適用各種預約型產業", "app/admin/patients/page.tsx|assignPatientMembershipLevelAction"]],
