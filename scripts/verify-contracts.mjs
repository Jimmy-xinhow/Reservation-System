...
const checks = [
  ...
  ["appointment operations use modal editors and a scan-friendly calendar", ["app/admin/appointments/new/page.tsx|<AppointmentEditor", "app/admin/appointments/[id]/reschedule/page.tsx|appointmentId={id}", "app/admin/page.tsx|完成／結帳", "app/admin/page.tsx|variant=\"modal\"", "app/admin/calendar/CalendarWorkspace.tsx|calendar-event-content", "app/admin/calendar/CalendarWorkspace.tsx|serviceName", "app/admin/calendar/CalendarWorkspace.tsx|providerColor", "app/api/admin/calendar/route.ts|color: \"#2563eb\""]],
