...
const checks = [
  ...
  ["appointment operations use dedicated editors and a scan-friendly calendar", ["app/admin/appointments/new/page.tsx|<AppointmentEditor", "app/admin/appointments/[id]/reschedule/page.tsx|appointmentId={id}", "app/admin/page.tsx|完成／結帳", "app/admin/page.tsx|appointment-list-toolbar", "app/admin/calendar/CalendarWorkspace.tsx|calendar-event-content", "app/admin/calendar/CalendarWorkspace.tsx|serviceName", "app/admin/calendar/CalendarWorkspace.tsx|providerName", "app/api/admin/calendar/route.ts|color: \"#2563eb\""]],
  ["checkout creation is independent and sale prices are editable", ["app/admin/checkout/new/page.tsx|<CreateSalesOrderForm", "app/admin/checkout/new/CreateSalesOrderForm.tsx|不會預設成現場顧客", "app/admin/checkout/new/CreateSalesOrderForm.tsx|本次服務／報名金額", "app/admin/checkout/page.tsx|成交單價", "app/admin/checkout/actions.ts|updateSalesOrderItemAction", "app/admin/checkout/actions.ts|調整後金額不可低於已收款金額"]],
