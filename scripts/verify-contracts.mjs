...
const checks = [
  ...
  ["appointment operations use modal editors and a scan-friendly calendar", ["app/admin/appointments/new/page.tsx|<AppointmentEditor", "app/admin/appointments/[id]/reschedule/page.tsx|appointmentId={id}", "app/admin/page.tsx|完成／結帳", "app/admin/page.tsx|variant=\"modal\"", "app/admin/calendar/CalendarWorkspace.tsx|calendar-event-content", "app/admin/calendar/CalendarWorkspace.tsx|serviceName", "app/admin/calendar/CalendarWorkspace.tsx|providerColor(props.providerId, doctors)", "app/api/admin/calendar/route.ts|providerId: row.doctor_id", "app/api/admin/calendar/route.ts|color: \"#2563eb\""]],
  ["checkout creation uses a modal and sale prices are editable", ["app/admin/checkout/new/page.tsx|<SalesOrderEditor", "app/admin/checkout/page.tsx|variant=\"modal\"", "app/admin/checkout/new/CreateSalesOrderForm.tsx|不會預設成現場顧客", "app/admin/checkout/new/CreateSalesOrderForm.tsx|本次服務／報名金額", "app/admin/checkout/AddSalesItemPanel.tsx|服務", "app/admin/checkout/AddSalesItemPanel.tsx|商品", "app/admin/checkout/AddSalesItemPanel.tsx|套票", "app/admin/checkout/AddSalesItemPanel.tsx|自訂品項", "app/admin/checkout/page.tsx|成交單價", "app/admin/checkout/actions.ts|updateSalesOrderItemAction", "app/admin/checkout/actions.ts|調整後金額不可低於已收款金額"]],
  ["staff attendance is tenant scoped and preserves every punch", ["supabase/migrations/202609070002_staff_attendance.sql|create table if not exists public.attendance_events", "supabase/migrations/202609070002_staff_attendance.sql|attendance_events_line_event_unique_idx", "supabase/migrations/202609070002_staff_attendance.sql|enable row level security", "app/admin/attendance/page.tsx|出勤打卡", "app/admin/handoff/attendance-actions.ts|recordButtonAttendanceAction", "app/admin/handoff/attendance-actions.ts|recordQrAttendanceAction", "app/admin/handoff/AttendancePanels.tsx|attendance-live-clock", "app/admin/handoff/AttendancePanels.tsx|上班打卡", "app/admin/handoff/AttendancePanels.tsx|下班打卡", "app/api/line/webhook/route.ts|text === \"上班打卡\"", "lib/attendance.ts|本次紀錄已新增，不會覆蓋先前紀錄"]],
