...
export default function ContactPage() {
  return <MarketingShell>
    <PageIntro eyebrow="Start with the real workflow" title="先談你的工作方式 再談要開哪些功能" description="我們不從套版畫面開始，而是先理解你的品牌、服務目標、資源與顧客入口，再一起決定適合的產品模組與導入順序。" visual={<PageIntroVisual variant="contact" photoSrc="/marketing/contact-onboarding.png" photoAlt="品牌業主與導入顧問討論服務流程" photoCaption="情境示意：從品牌自己的流程開始討論，而不是先套用畫面。" />}>
      <a href="tel:079721612" className="btn min-h-12 rounded-full bg-[#173f48] px-5 font-bold text-white hover:bg-[#2d6871]">撥打導入專線 <span className="text-[#f1ca5b]">07-9721612</span></a>
      <a href="https://lin.ee/jnAfCBy" target="_blank" rel="noreferrer" className="btn min-h-12 rounded-full border border-[#1f4550]/20 bg-[#fff0bd] px-5 font-bold text-[#173f48] hover:bg-[#f1d36f]">加入官方 LINE <span>@xinhow</span></a>
    </PageIntro>
