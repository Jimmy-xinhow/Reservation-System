...
export default function ContactPage() {
  return <MarketingShell>
    <PageIntro eyebrow="Start with the real workflow" title="先談你的工作方式，再談要開哪些功能。" description="我們不從套版畫面開始，而是先理解你的品牌、服務目標、資源與顧客入口，再一起決定適合的產品模組與導入順序。"><a href="tel:079721612" className="btn min-h-12 bg-[#1f4550] px-5 text-white hover:bg-[#193b43]">撥打導入專線 <span className="text-[#e2b644]">07-9721612#888</span></a><Link href="/product" className="btn min-h-12 border border-[#1f4550]/20 bg-white/70 px-5 text-[#1f4550] hover:bg-white">先看產品能力</Link></PageIntro>
