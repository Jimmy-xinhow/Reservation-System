...
export default function ContactPage() {
  return <MarketingShell>
    ...
    <section className="bg-[#193b43] px-5 py-16 text-white sm:px-8 sm:py-20 lg:px-10"><div className="mx-auto max-w-7xl"><div className="grid gap-8 lg:grid-cols-[.72fr_1.28fr] lg:items-end lg:gap-16"><div><p className="eyebrow !text-[#e2b644]">Choose the easiest channel</p><h2 className="text-3xl font-bold leading-tight tracking-tight sm:text-4xl">不用先寫規格書，先從一個問題開始。</h2><p className="mt-4 max-w-xl text-base leading-7 text-[#c9dcda]">依你的方便選擇電話、Email 或官方 LINE，我們再把品牌、入口與工作流程整理成可執行的導入路徑。</p></div><SignalStrip dark items={[{ label: "電話", value: "07-9721612", detail: "直接討論目前卡點" }, { label: "Email", value: "service@xinhow.com.tw", detail: "適合補充品牌資料" }, { label: "LINE", value: "@xinhow", detail: "官方帳號快速聯絡" }, { label: "後台", value: "既有帳號", detail: "登入查看系統骨架" }]} /></div><div className="mt-10"><WorkflowRail dark steps={[{ label: "01", title: "說明現況", detail: "品牌、服務與入口" }, { label: "02", title: "拆解流程", detail: "角色、排程與資料" }, { label: "03", title: "確認範圍", detail: "標準功能與加購" }, { label: "04", title: "規劃導入", detail: "交付、訓練與驗收" }]} /></div></div></section>
