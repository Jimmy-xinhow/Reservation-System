...
import { Callout, FeatureIcon, MarketingShell, ModuleInterface, PageIntro, PageIntroVisual, ScenarioMatrix, SectionHeading, SignalStrip, type ModuleKind } from "@/components/MarketingLayout";
...
export default function SolutionsPage() {
  return <MarketingShell>
    ...
    <section className="bg-[#eef3ef] px-5 py-16 sm:px-8 sm:py-20 lg:px-10"><div className="mx-auto max-w-7xl"><div className="grid gap-8 lg:grid-cols-[.7fr_1.3fr] lg:items-end lg:gap-16"><div><p className="eyebrow !text-[#b08116]">One core, many operating shapes</p><h2 className="text-[clamp(1.75rem,3.2vw,2.75rem)] font-bold leading-[1.12] tracking-[-0.04em] text-[#193b43]">同一套核心，對應不同的工作方式。</h2><p className="mt-4 text-base leading-7 text-[#5d6d6b]">視覺化看出差異：入口、安排與完成方式可以不同，但資料仍然回到同一個營運系統。</p></div><SignalStrip items={[{ label: "一對一", value: "服務時段", detail: "人員／資源" }, { label: "課程活動", value: "場次票種", detail: "容量／報到" }, { label: "場地設備", value: "資源排程", detail: "避免重複預約" }, { label: "多品牌", value: "資料隔離", detail: "品牌資料範圍" }]} /></div><div className="mt-10"><ScenarioMatrix /></div></div></section>
