...
export default function ProductPage() {
  return <MarketingShell>
    ...
    <section className="bg-[#193b43] px-5 py-16 text-white sm:px-8 sm:py-20 lg:px-10"><div className="mx-auto max-w-7xl"><div className="grid gap-10 lg:grid-cols-[.68fr_1.32fr] lg:items-center lg:gap-16"><div><p className="eyebrow !text-[#e2b644]">顧客經營工作畫面</p><h2 className="text-[clamp(1.8rem,3.2vw,2.8rem)] font-bold leading-[1.1] tracking-[-0.045em]">先看狀態，再決定下一個動作。</h2><p className="mt-4 max-w-xl text-base leading-7 text-[#c9dcda]">品牌團隊可以從顧客清單、互動時間軸、通知紀錄與營運報表，判斷服務完成後的下一步。</p></div><DashboardMockup variant="customer" /></div><div className="mt-10"><SignalStrip dark items={[{ label: "顧客", value: "互動脈絡", detail: "分眾與時間軸" }, { label: "通知", value: "LINE／Email", detail: "提醒與投遞紀錄" }, { label: "回訪", value: "規則式流程", detail: "依條件接續經營" }, { label: "報表", value: "資料回看", detail: "品牌日期範圍" }]} /></div></div></section>
