...
import { createInventoryItemAction, recordInventoryMovementAction, saveCommissionRuleAction } from "./actions";
...
const MOVEMENT_LABEL: Record<string, string> = { stock_in: "進貨", use: "服務使用", sale: "零售售出", waste: "報廢", stocktake: "盤點調整" };
...
export default async function BeautyOperationsPage() {
  ...
  const firstError = [inventoryResult, movementsResult, doctorsResult, servicesResult, rulesResult, completedResult].find((result) => result.error)?.error;
