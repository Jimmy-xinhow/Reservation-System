...
export default async function BeautyOperationsPage() {
  ...
  return <div className="space-y-8">
    <header className="flex flex-wrap items-end justify-between gap-3"><div><div className="eyebrow">可選產業模組</div><h1 className="text-2xl font-bold text-slate-900">美業營運</h1><p className="mt-1 text-sm leading-6 text-slate-500">療程紀錄、私密照片、耗材庫存與服務獎金試算集中管理。這裡不包含會計、發票或完整 POS 結帳。</p></div><div className="flex gap-2"><Link href="/admin/beauty/supply" className="btn btn-secondary">採購與盤點</Link><Link href="/admin/documents" className="btn btn-secondary">同意書與簽署</Link></div></header>
