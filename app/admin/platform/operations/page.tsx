    ...
    <div className="platform-workbench">
      ...
      <section className="platform-overview-grid">
        ...
        <div className="platform-panel space-y-4 p-5">
          ...
          {warningCount > 0 ? <p className="border-l-2 border-amber-500 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-800">目前有通知失敗紀錄，請先由品牌後台確認顧客是否已同意接收行銷訊息、LINE／Email 設定與排程錯誤，再決定是否重試。</p> : <p className="border-l-2 border-emerald-500 bg-emerald-50 px-4 py-3 text-xs leading-5 text-emerald-800">目前沒有通知失敗紀錄；仍需持續觀察同日新增預約與報名的提醒佇列。</p>}
        </div>
      </section>
