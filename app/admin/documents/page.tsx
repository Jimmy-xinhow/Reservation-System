...
export default async function DocumentsPage({ searchParams }: { searchParams: Promise<{ request_id?: string; sign_token?: string }> }) {
  ...
  return <div className="admin-page">
    <div className="admin-page-header"><div><p className="eyebrow">設定中心</p><h1 className="admin-page-title">同意書與電子簽署</h1><p className="admin-page-description">建立版本化範本，發出限時簽署連結，並保存當時內容與簽署時間。</p></div></div>
