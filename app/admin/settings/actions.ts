...
export async function updateBrandPageAction(fd: FormData): Promise<void> {
  ...
  const content: BrandPageContent = {
    ...
    app_shortcut_title: brandPageText(fd, "app_shortcut_title", 50),
    app_shortcut_description: brandPageText(fd, "app_shortcut_description", 120),
    app_shortcut_button_label: brandPageText(fd, "app_shortcut_button_label", 24),
