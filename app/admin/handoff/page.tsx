...
export default async function HandoffPage({ searchParams }: { searchParams: Promise<{ status?: string; category?: string; priority?: string; assignee?: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <header><p className="eyebrow">Shift handoff</p><h1 className="mt-1 text-2xl font-bold text-slate-900">交班待辦</h1><p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">把預約、付款、顧客與渠道問題集中交接；用狀態、分類、優先度與負責人快速篩選。</p></header>
