...
export default function BrowserBookingPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      const body: Record<string, unknown> = { browser_token: browserToken, doctor_id: doctorId, service_id: serviceId || undefined, visit_type: visitType, is_self_pay: false, membership_code: membershipCode.trim().toUpperCase() || undefined };
