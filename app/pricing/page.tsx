...
export default function PricingPage() {
  return <MarketingShell>
    <PageIntro dark eyebrow="Plans & service boundary" title="先把商業邊界說清楚，再一起把系統做好。" description="標準功能以完整的預約與報名營運為核心；清單外的特殊串接或客製模組另行評估、報價與確認，維護合約不會默默變成新功能開發。" visual={<PageIntroVisual variant="pricing" dark photoSrc="/marketing/pricing-scope-planning.png" photoAlt="團隊在桌上整理流程與導入範圍" photoCaption="實際工作情境：先把流程、範圍與驗收方式在桌面上對齊。" />}><Link href="/contact" className="btn min-h-12 bg-[#e2b644] px-5 font-semibold text-[#193b43] hover:bg-[#f1ca5b]">詢問導入範圍 <span aria-hidden="true">↗</span></Link><Link href="/product" className="btn min-h-12 border border-white/20 bg-white/5 px-5 text-white hover:bg-white/10">查看產品模組</Link></PageIntro>
