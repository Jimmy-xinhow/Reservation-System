...
import { ArrowLink, Callout, CapabilityCard, DashboardMockup, FeatureIcon, MarketingPhoto, MarketingShell, PhotoBand, SectionHeading, SignalStrip, WorkflowRail } from "@/components/MarketingLayout";
...
export function MarketingHome() {
  return <MarketingShell>
    ...
    <PhotoBand src="/marketing/hero-service-counter.png" alt="服務現場的接待與排程作業" eyebrow="看見真實工作現場" title="讓入口與現場工作接得起來" description="從顧客進入、服務安排到團隊交接，畫面呈現的是可以落地執行的工作流程。" />
