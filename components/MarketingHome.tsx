...
import { ArrowLink, Callout, CapabilityCard, FeatureIcon, MarketingPhoto, MarketingShell, PlatformPreview, SectionHeading, SignalStrip, WorkflowRail } from "@/components/MarketingLayout";
...
export function MarketingHome() {
  return <MarketingShell>
    ...
    <section className="bg-[#193b43] px-5 py-20 text-white sm:px-8 sm:py-24 lg:px-10"><div className="mx-auto max-w-7xl"><div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr] lg:items-center lg:gap-16"><div><p className="eyebrow !text-[#e2b644]">平台與品牌分層</p><h2 className="text-[clamp(2rem,4vw,3.4rem)] font-bold leading-[1.05] tracking-[-0.05em]">讓每天要處理的事情，在正確的管理層裡發生。</h2><p className="mt-5 max-w-xl text-base leading-7 text-[#c9dcda]">系統擁有者管理品牌租戶與平台健康；品牌團隊管理自己的預約、報名、顧客與通知。</p><div className="mt-8"><ArrowLink href="/product" dark>看產品如何分層</ArrowLink></div></div><PlatformPreview /></div><div className="mt-12"><WorkflowRail steps={[{ label: "顧客入口", title: "看見與進入", detail: "LINE Rich Menu、LIFF、瀏覽器" }, { label: "服務作業", title: "預約或報名", detail: "時段、場次、付款、報到" }, { label: "團隊處理", title: "提醒與交接", detail: "狀態、通知、例外日期" }, { label: "後續經營", title: "回訪與分析", detail: "CRM Lite、分眾、報表" }]} dark /></div></div></section>
