...
- `npm run smoke:public`：PASS；以本次 production build 在獨立 3209 port 執行，六個公開頁（`/`、`/register`、`/register/pay`、`/book/browser`、`/embed/register`、`/admin/login`）回 200，三支 Cron 未授權回 401。
