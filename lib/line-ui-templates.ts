...
export const LINE_UI_TEMPLATES: LineUiTemplateDefinition[] = [
  ...
  { key: "account_link", category: "member", title: "LINE 會員綁定", trigger: "首次查詢個人資料", headline: "第一次使用，還是已有會員？", body: "第一次使用會先驗證 LINE 身分後建立品牌會員；已有資料才進行姓名、電話與生日比對。", details: [["第一次使用", "建立會員並綁定 LINE"], ["已有會員", "比對後連回原紀錄"]], primaryAction: "第一次使用・建立會員", secondaryAction: "已有會員・連回資料", badge: "會員服務", accent: "#315C50", systemManaged: true },
